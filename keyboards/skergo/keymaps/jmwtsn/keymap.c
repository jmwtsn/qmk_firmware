...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		LCTL(KC_BSPC),    KC_A,   KC_S,  KC_D,   KC_F,    KC_G,        KC_H,    KC_J,    KC_K,   KC_L,    KC_SCLN, KC_QUOT, LT(3,KC_ENT),         KC_PGDN,
	...
	[1] = LAYOUT(
		...
		_______, _______, _______, _______, _______, _______,              KC_P4,   KC_P5,   KC_P6,   _______, _______, _______, _______,          KC_VOLD,
	...
	[3] = LAYOUT(
		_______, MSG,     NML,     RNA,     GEN,     BSIG,    DNC,      DNC2,    NIS,     _______, _______, _______, _______, _______, _______,
